...
import { Cloud, Globe, HardDrive, Info, Maximize2, Package, Settings2 } from '@/componentsV2/icons/LucideIcon'
  ...
  const settingsItems: SettingGroupConfig[] = [
    ...
    },
    {
      ...
      items: [
        ...
        // Only show floating window settings on Android
        ...(Platform.OS === 'android'
          ? [
              {
                title: t('settings.floatingwindow.title'),
                screen: 'FloatingWindowSettings',
                specificScreen: 'FloatingWindowSettingsScreen',

...
import FloatingWindowStackNavigator from './settings/FloatingWindowStackNavigator'
...
export type SettingsStackParamList = {
  ...
  FloatingWindowSettings: undefined
...
export default function SettingsStackNavigator() {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="FloatingWindowSettings" component={FloatingWindowStackNavigator} />
